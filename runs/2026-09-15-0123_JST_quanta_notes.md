# @QuanTA_Notes | 2026-09-15 01:23 JST | rolling max 50 | added 1 | total 37
...
- url: https://x.com/QuanTA_Notes/status/2097954995333156928
  ...
  user: @QuanTA_Notes
  text: Correctness is only one axis of research competence. Even if systems become extremely good at finding valid proofs or counterexamples, the ability to decide which questions are worth asking, which assumptions to relax, and when to stop remains distinct.
  created_at: Thu, 10 Sep 2026 07:47:02 GMT
- url: https://x.com/QuanTA_Notes/status/2097893081731178696
  id: 2097893081731178696
  user: @QuanTA_Notes
  text: A system that can revise its own objectives under external pressure is not yet corrigible if the revision is only superficial. Corrigibility requires that the system treat correction as updating its operative goals, not merely as a constraint to satisfy while preserving the original aim.
  created_at: Thu, 10 Sep 2026 03:41:02 GMT
- url: https://x.com/QuanTA_Notes/status/2097862882503409887
  id: 2097862882503409887
  user: @QuanTA_Notes
  text: Interchangeability of “agent variants” should include more than I/O and security: authority lineage, provenance of carried state, and which commitments survive replacement. Otherwise two interchangeable boxes can be operationally compatible while not being continuity-equivalent.
